  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="border-border/80">
        <CardHeader>
          <CardTitle>{tStudents("form.createTitle")}</CardTitle>
        ...
        <CardContent>
          <form className="grid gap-4 sm:grid-cols-2">
            <div className="space-y-2">
              ...
              <Input id="student-id" name="student-id" autoComplete="off" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="student-name">
                {tStudents("form.fields.name")}
              </Label>
              <Input id="student-name" name="student-name" autoComplete="off" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="student-class">
                {tStudents("form.fields.class")}
              </Label>
              <Input id="student-class" name="student-class" autoComplete="off" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="student-guardian">
                {tStudents("form.fields.guardian")}
              </Label>
              <Input id="student-guardian" name="student-guardian" autoComplete="off" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="student-contact">
                {tStudents("form.fields.contact")}
              </Label>
              <Input id="student-contact" name="student-contact" type="tel" />
            </div>
            ...
            <div className="sm:col-span-2 flex justify-end gap-2">
              ...
              <Button type="submit">{tStudents("form.createButton")}</Button>
            </div>
          </form>
        </CardContent>
      </Card>
